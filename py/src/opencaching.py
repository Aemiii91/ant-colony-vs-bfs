...
def search(latitude: float = 52.518848, longitude: float = 13.399411, count: int = 500, types: str = "-Multi|Quiz|Moving", radius: float = 50000):
    """
    ...
    args = {
        ...
        "retr_params": json.dumps({
            "fields": "location|type|difficulty|terrain"
        }),
        "wrap": "true",
