  ...
  void SetUp() override {
	...
	this->costMatrix =
		MatrixDouble{{0.0, 441.95, 519.73, 400.86, 630.96, 690.94, 708.62,
					 ...
					 {798.7, 1172.23, 1263.91, 725.93, 1082.63, 333.25, 1384.22,
					  0.0, 852.55, 1226.65},
					 {608.35, 848.98, 1053.36, 217.55, 1239.31, 559.99, 1039.54,
					  844.6, 0.0, 556.99},
					 {716.48, 757.71, 875.49, 753.9, 1347.44, 1075.64, 659.97,
					  1295.14, 556.99, 0.0}};
  }
...
TEST_F(ACOTest, ColonySolveTest) {
  ...
  ACOTest::PrintSolution(solution);
