...
def acorunner(x):
    ...
    upperScore = 500
    staticDataset = '"munchen.json"'
    staticparams1 = 'aco --data ' + staticDataset + '--colonies 1 --ants 409 --iterations 90'
    staticparams2 = 'aco --data ' + staticDataset + '--colonies 1 --ants 409 --iterations 90'
    staticparams3 = 'aco --data ' + staticDataset + '--colonies 1 --ants 409 --iterations 90'
