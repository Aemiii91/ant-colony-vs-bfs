...
def acorunner(x):
    ...
    upperScore = 500
    staticparams1 = 'aco --data "munchen.json" --colonies 1 --iterations 500000000 --time 60 '
    staticparams2 = 'aco --data "berlin.json" --colonies 1 --iterations 500000000 --time 60  '
    staticparams3 = 'aco --data "hamburg.json" --colonies 1 --iterations 500000000 --time 60  '
